...
> **Status:** v0.1.0 scaffold — page + text contracts, hello-world capable. The other eight `presentation-base` contracts (`data-table`, `form`, `markdown`, `chat`, `metric`, `nav-bar`, `toast`, `banner`) land in subsequent slices.
